...
public class DefaultHttpClientBuilder extends HttpClientBuilder {
     ...
     */
    @Deprecated
    public DefaultHttpClientBuilder timeout(int timeout){
     ...
     */
    @Deprecated
    public DefaultHttpClientBuilder timeout(int timeout,  boolean redirectEnable){
        // 配置请求的超时设置
...
//		return (DefaultHttpClientBuilder) this.setConnectionManager(connManager);
        return (DefaultHttpClientBuilder) this.setSSLSocketFactory(ssls.getSSLCONNSF(sslpv));
    }
     ...
     * @	http处理异常
     */
    public DefaultHttpClientBuilder ssl(String keyStorePath) {
     ...
     * @	http处理异常
     */
    public DefaultHttpClientBuilder ssl(String keyStorePath, String keyStorepass) {
...
//		this.isNewSSL=true;
     ...
     * @return	返回当前对象
     */
    public DefaultHttpClientBuilder sslpv(String sslpv){
     ...
     * @return	返回当前对象
     */
    public DefaultHttpClientBuilder sslpv(SSLs.SSLProtocolVersion sslpv){
        this.sslpv = sslpv;
        return this;
    }
}
