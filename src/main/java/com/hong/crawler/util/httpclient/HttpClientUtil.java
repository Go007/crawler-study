package com.hong.crawler.util.httpclient;
...
public class HttpClientUtil {
	...
	static{
		try {
			client4HTTP = DefaultHttpClientBuilder.custom().build();
			client4HTTPS = DefaultHttpClientBuilder.custom().ssl().build();
		} catch (Exception e) {
	 ...
	 * 
	 * @param config		请求参数配置
	 * @throws Exception	http处理异常
	 */
	private static void create(HttpConfig config) throws Exception  {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String get(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String post(HttpClient client, String url, Header[] headers, Map<String,Object>parasMap, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String put(HttpClient client, String url, Map<String,Object>parasMap, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String delete(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String patch(HttpClient client, String url, Map<String,Object>parasMap, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常
	 */
	public static String patch(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String head(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常
	 */
	public static String head(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String options(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常
	 */
	public static String options(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String trace(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws Exception {
	 ...
	 * @throws Exception	http处理异常
	 */
	public static String trace(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String upload(HttpClient client, String url, Header[] headers, HttpContext context) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static String upload(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static int status(HttpClient client, String url, Header[] headers, HttpContext context, HttpMethods method) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	public static int status(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常
	 */
	public static HttpResult sendAndGetResp(HttpConfig config) throws Exception {
	 ...
	 * @throws Exception	http处理异常 
	 */
	private static int fmt2Int(HttpResponse resp) throws Exception {
		int statusCode;
		try {
